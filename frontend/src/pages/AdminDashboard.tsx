    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">You need to be logged in as an administrator to access this page.</p>
        </div>
      </div>
    );
  }
            ...
            <div className="p-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-sm text-gray-600">Chat session started</p>
                  <span className="text-xs text-gray-400">5 min ago</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                  <p className="text-sm text-gray-600">Support ticket created</p>
